...
// Read full file: "cargo run sample.txt"       
// Read with line numbers: "cargo run sample.txt --lines"      
// Search for keyword: "cargo run sample.txt --search Rust"      
// Search with line numbers: "cargo run sample.txt --lines --search Rust"